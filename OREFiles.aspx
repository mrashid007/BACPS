<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OREFiles.aspx.cs" Inherits="FloraSoft.OREFiles" %>
...
<body topmargin="0" leftmargin="0">
    ...
    <div>
        <uc1:AdminHeader ID="AdminHeader1" runat="server" />
            <div class="Head" align="center">List of Outward Return XML Files&nbsp;&nbsp;<asp:Label ID="FTPConnectMsg" CssClass="NormalRed" runat="server" ></asp:Label></div>
            
            <asp:DataList ID="FileList" runat="Server" 
                HorizontalAlign="Center"
                ItemStyle-CssClass="Normal" 
                DataKeyField="FileName" RepeatColumns="1" 
