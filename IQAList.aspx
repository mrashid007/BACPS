<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IQAList.aspx.cs" Inherits="FloraSoft.IQAList" %>
<%@ Register Src="Modules/OCEBatchTree.ascx" TagName="OCEBatchTree" TagPrefix="uc2" %>
<%@ Register Src="modules/CommonHeader.ascx" TagName="AdminHeader" TagPrefix="uc1" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td><div class="Head" align="left">IQA List</div></td>
                            <td width="50"></td>
                    ...
                    <asp:DataGrid ID="BatchFileGrid" runat="server"  
                       ...
                       <Columns>
                         <asp:EditCommandColumn CausesValidation="False" EditText="Edit" UpdateText="Resend" CancelText="Cancel"></asp:EditCommandColumn>
                        ...
                        <asp:TemplateColumn HeaderText="Session" ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" >
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container.DataItem, "ClearingTypeName")%>
                            </ItemTemplate>
                        </asp:TemplateColumn>                    
                        ...
                        <asp:TemplateColumn HeaderText="CheckSLNo" ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Right" >
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="CheckSLNo" Width="50"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "CheckSLNo") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateColumn> 
                        ...
                        <asp:TemplateColumn HeaderText="TC" ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Center" >
                         ...
                         <asp:BoundColumn DataField="CheckAmount" HeaderText="Amount" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:F2}"  />                           
