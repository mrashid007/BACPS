<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InwardMaker.aspx.cs" Inherits="FloraSoft.InwardMaker" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ViewCheck(n) {
            ...
            window.open(str, 'CheckImage', 'scrollbars=no,width=860,height=430,left=260,top=150');
        }
...
<body topmargin="0" leftmargin="0">
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <a href="InwardList.aspx">
                        <img src="images/BACPSHeader.gif" width="1110" height="45" border="0"></a>
                </td>
            </tr>
            <tr>
                <td align="right">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td rowspan="2" valign="top" border="0" cellpadding="0" cellspacing="0">
                    <!-------------LEFT-------------------->
                            ...
                            <tr>
                                <td valign="top">
                                    <table border="0" cellpadding="0" cellspacing="4">
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <asp:Button ID="SaveReturnBtn" runat="server" Text="Save and Exit" CssClass="inputlt" Width="125px" Height="22px" OnClick="SaveExitBtn_Click" />
                                                <asp:DropDownList ID="ReturnReasonList" runat="server" Width="275px" DataTextField="ReturnReason" DataValueField="ReturnCD" />
                                                <asp:Button ID="SaveBtn" runat="server" Text="Save and Next" CssClass="inputlt" Width="125px" Height="22px" OnClick="SaveBtn_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td valign="top">
                                    ...
                                    <table cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td class="NormalBold">TC&nbsp;<asp:TextBox ID="TransactionCode" Enabled="false" runat="server" Width="40px"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                <asp:ListBox ID="CBSActList" CssClass="NormalSmall" OnSelectedIndexChanged="CBSActList_SelectedIndexChanged"
                                                    AutoPostBack="true" runat="server" Style="width: 285px; height: 70px" DataTextField="CUSTNAME" DataValueField="IMAGEID"></asp:ListBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="javascript:ViewSignature('<%=CBSActNo%>','<%= sigImageId %>');">
                                                    <img id="SignatureImage" alt="Signature not found" runat="server" style="width: 280px; height: 70px" /></a>
                                            </td>
                                        </tr>
                                    ...
                                    <div style="height: 80px; overflow: auto">
                                        <table bgcolor="white" height="78px" class="DarkBorderTable" cellpadding="1">
                                            <tr>
                                                <td><asp:Label ID="lblBalanceInfo" Font-Size="Small" runat="server" CssClass="NormalRed"></asp:Label></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblSPINST" Font-Size="Small" runat="server" CssClass="NormalSmallBlue"></asp:Label></td>
                                            </tr>
                                        </table>
                                    </div>
