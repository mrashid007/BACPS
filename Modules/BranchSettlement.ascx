        ...
        <td>
            ...
            <asp:GridView ID="SettlementGrid" runat="server"
               ...
               <Columns>
                   ...
                   <asp:BoundField  DataField = "OCE"       ItemStyle-Width = "60px"   ItemStyle-Wrap ="false" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Wrap="True"  DataFormatString="{0:F2}"/>
                   ...
                   <asp:BoundField  DataField = "ICE"       ItemStyle-Width = "60px"   ItemStyle-Wrap ="false" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Wrap="True"  DataFormatString="{0:F2}"/>
                   ...
                   <asp:BoundField  DataField = "ORE"       ItemStyle-Width = "60px"   ItemStyle-Wrap ="false" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Wrap="True"  DataFormatString="{0:F2}"/>
                   ...
                   <asp:BoundField  DataField = "IRE"       ItemStyle-Width = "60px"   ItemStyle-Wrap ="false" ItemStyle-HorizontalAlign="Right"  HeaderStyle-Wrap="True"  DataFormatString="{0:F2}"/>
               </Columns>	
           </asp:GridView>
           </DIV>
        </td>
