<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutwardCheckHistory.aspx.cs" Inherits="FloraSoft.OutwardCheckHistory" %>
...
<head runat="server">
    <title>Outward Cheque History</title>
    <link href="includes/sitec.css" rel="stylesheet" type="text/css" /> 
    <script>
    	function ViewCheck(checkid)
		{
			var str = 'ViewCheck.aspx?CheckID='+checkid;
			window.open(str,'CheckImage','scrollbars=no,width=800,height=680,left=20,top=10');
		}
    </script>
</head>
<body topmargin="0" leftmargin="0">
    ...
    <div>
       <div class="Head" align="center">Outward Cheque History</div>
       <table>
        <tr>
            <td width="80"></td>
            <td>
                ...
                <table>
                    <tr>
                        ...
                        <td class="NormalBold">History Month</td>
                        <td>			                    
                    ...
                    <tr><td align="right"><asp:CheckBox ID="DateCheckbox" runat="server"  /></td>
                        <td class="NormalBold">History Date</td>
                        <td colspan="2">
                    ...
                    <tr><td style="width: 83px" align=right><asp:CheckBox ID="ChkUserID" runat="server"  /></td>
                        <td class="NormalBold">LoginID</td>
                ...
                <asp:DataGrid ID="ChecksGrid" runat="server"  
                   ...
                   <Columns>
                        ...
                        <asp:BoundColumn DataField = "ItemSeqNo"        HeaderText="ItemSeqNo"        ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CheckDate"        HeaderText="Chq Date"         ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CheckSLNo"        HeaderText="Chq SLNo"         ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CheckRoutingNo"   HeaderText="CheckRoutingNo"   ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CheckActNo"       HeaderText="Chq Act No"       ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CheckTransCode"   HeaderText="TransCode"        ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CheckAmount"      HeaderText="Amount"           ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "BenefActNo"       HeaderText="BenefActNo"       ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "BenefName"        HeaderText="Benef Name"       ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "MICRValidInd"     HeaderText="MICRValidInd"     ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "CorrectionInd"    HeaderText="CorrectionInd"    ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "StatusName"       HeaderText="Status"           ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField = "BatchID"          HeaderText="BatchID"          ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                  </Columns>
