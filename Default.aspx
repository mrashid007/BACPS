...
<%@ Register Src="modules/ICEBranchStatusSmall.ascx" TagName="ICEBranchStatus"   TagPrefix="uc3" %>
...
<body topmargin="0" leftmargin="0" bgcolor="red">
    <form id="form1" runat="server" >
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="1240" height="600">
            <tr height="1"><td colspan="4"><uc1:AdminOpManagerHeader ID="AdminOpManagerHeader1" runat="server" /></td></tr>
            <tr>
                <td valign="top">
                    <!----------------------LEFT PANE----------------------------->
                   ...
                   <asp:UpdatePanel ID="UpdatePanel7" runat="server"> 
                    ...
                    <asp:UpdatePanel ID="UpdatePanel12" runat="server"> 
                        <ContentTemplate> 
                            <uc12:ICERejectedStatus ID="ICERejectedStatus1" Height="65px" ECEType="19" runat="server" />
                        </ContentTemplate> 
                         <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                        </Triggers> 
                ...
                <td valign="top">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server"> 
                        <ContentTemplate> 
                            <uc3:ICEBranchStatus ID="ICEBranchStatus1" Height="78px" ECEType = "19" runat="server" />
                        </ContentTemplate>  
                            <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                        </Triggers> 
                   ...
                   <table height="3"><tr><td></td></tr></table>
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server"> 
                        <ContentTemplate> 
                             <uc3:ICEBranchStatus ID="ICEBranchStatus2" Height="78px" ECEType = "11" runat="server" />
                       </ContentTemplate> 
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                        </Triggers> 
                   ...
                   <table height="3"><tr><td></td></tr></table>
                    ...
                    <table height="3"><tr><td></td></tr></table>
                     <asp:UpdatePanel ID="UpdatePanel10" runat="server"> 
                        <ContentTemplate> 
                            <uc12:ICERejectedStatus ID="ICERejectedStatus2" Height="65px" ECEType="11" runat="server" />
                       </ContentTemplate>  
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                        </Triggers> 
                ...
                <td valign="top">
                    ...
                    <table height="3"><tr><td></td></tr></table>
                    <uc13:AdminCBS ID="AdminCBS1" runat="server" />
                    <table height="3"><tr><td></td></tr></table>
