<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ICEReview.aspx.cs" Inherits="FloraSoft.ICEReview" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
    	...
    	function ViewSignature(accNo, curInd)
    	{
    	    var Item = 'ViewSignature.aspx?AccountNo=' + accNo + "&CurInd=" + curInd + "&checkid=" + checkid;
...
<body topmargin="0" leftmargin="0">
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr><td><a href="InwardReview.aspx"><img src="images/BACPSHeader.gif" width="1110" height="45" border="0"></a></td></tr>
        ...
        <tr>
            <td width="100%" valign="top" border="0" cellpadding="0" cellspacing="0">
                ...
                <table cellspacing="1" cellspacing="0" width="260px">
                    ...
                    <tr bgcolor="#a0f6a2">
                        ...
                        <td><asp:Label ID="CheckSLNo" runat="server" CssClass="NormalLargeBold"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#a0f6a2">
                        <td class="Normal">Routing No</td>
                        <td><asp:Label ID="IssueRoutingNo" runat="server" CssClass="NormalLargeBold"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#a0f6a2">
                        <td class="Normal">Account No</td>
                        <td><asp:Label ID="AccountNo" runat="server" CssClass="NormalLargeBold"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#a0f6a2">
                    ...
                    <tr bgcolor="lightyellow">
                        ...
                        <td><asp:Label ID="CheckDate" runat="server" CssClass="Normal"></asp:Label></td>
                    </tr>
                    <tr bgcolor="lightyellow">
                    ...
                    <tr bgcolor="lightblue">
                        ...
                        <td><asp:Label ID="RepresentmentIndicator" runat="server" CssClass="Normal"></asp:Label></td>
                    </tr>
                    <tr bgcolor="lightblue">
                        <td class="Normal">MICR valid</td>
                        <td><asp:Label ID="MICRValidIndicator" runat="server" CssClass="Normal"></asp:Label></td>
                    </tr>
                    <tr bgcolor="lightblue">
                    ...
                    <tr bgcolor="#e8ceeb">
                        ...
                        <td><asp:Label ID="SettlementDate" runat="server" CssClass="Normal"></asp:Label></td>
                    </tr>
                    <tr bgcolor="#e8ceeb">
                        <td class="Normal">
                            Time</td>
            ...
            <td width="550" valign="top" align="left">
                <!---------------CENTER PANE------------------>
                <table width="545">
                    <tr><td align="center" nowrap><asp:Label ID="Msg" CssClass="NormalRed" runat="server"></asp:Label></td></tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="4">
                    <tr>
                        <td>
                            <a href="#" onclick="ViewCheck(0)"><asp:Image ID="FrontImage" BorderWidth="1" BorderColor="Black" runat="Server" Width="540" Height="225" /></a></td>
                    </tr>
                    <tr>
                        <td>
                            <a href="#" onclick="ViewCheck(1)"><asp:Image ID="BackImage" BorderWidth="1" BorderColor="Black" runat="Server" Width="540" Height="225" /></a></td>
                    </tr>
                </table>
                <table border="0" cellpadding="0" cellspacing="3">
                    <tr>
                        ...
                        <td width="200px">&nbsp;</td>
                        <td width="4"></td>
                        <td><asp:Button ID="NextBtn" runat="server" Text="Next" CssClass="inputlt" Width="135" Height="22px" OnClick="NextBtn_Click" /></td>
                    </tr>
                </table>
                </asp:Panel>
               <!---------------END CENTER PANE-------------->
            ...
            <td valign="top">
               <!---------------RIGHT PANE------------------>
                <table border="0" cellpadding="0" cellspacing="0" >
                    <tr>
                        <td><asp:DropDownList ID="ClearingTypeList" runat="server" Enabled="false">
                                <asp:ListItem Text="All" Value="0"></asp:ListItem>
                                <asp:ListItem Text="HV"  Value="19"></asp:ListItem>
                                <asp:ListItem Text="RV" Value="11"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="NormalBold">RTN&nbsp;<asp:TextBox ID="TransactionCode" Enabled="false" runat="server" Width="40px" CssClass="inputltDisabled" MaxLength="2"></asp:TextBox></td>
                    </tr>
                </table> 
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                ...
                <input type="hidden" id="DIN" value="0" runat="server" />
               <!---------------END RIGHT PANE-------------->
           </td>
        </tr>
